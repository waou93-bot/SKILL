...
When media must stay coherent across several frames, scenes, deliverables, variants, or projects, load `asset-continuity`. Map the resolver's frozen files and ledger records into stable asset IDs and canonical references; do not create a competing inventory. Preserve the exact approved logo, voice, grade, LUT, icon family, image treatment and source provenance across derivatives unless a versioned change is recorded.
