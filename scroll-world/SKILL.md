...
Before generating scenes for a named industry or brand, invoke `toolbox` to scout relevant visual, UX, 3D, video and interaction references, plus currently available tools and media sources. Use the result to inform the world concept and scene grammar; keep this skill's provider, cost, seam and capability checks authoritative, and never copy a reference site's assets or choreography.
